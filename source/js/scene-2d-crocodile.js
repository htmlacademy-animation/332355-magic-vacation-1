...
const IMAGES_URLS = Object.freeze({
  ...
  // waterlemon: `/img/module-4/lose-images/waterlemon.png`
});
...
export default class Scene2DCrocodile extends Scene2D {
  constructor() {
    ...
    this.afterInit = () => {
      this.objects.crocodile.before = this.drawBlob.bind(this);
    };
  ...
  initcrocodileAnimations() {
    this.animations.push(new Animation({
      func: (progress) => {
        ...
        this.objects.crocodile.transforms.translateX = 220 * progressReversed;
  ...
  initBlobAnimations() {
    this.animations.push(new Animation({
      func: (progress) => {
        ...
        this.locals.blob.radius = 5 * progress;
